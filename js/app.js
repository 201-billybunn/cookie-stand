...
// Object methods
locationOne.calcCustomersEachHour = function () {
...
locationOne.calcCookiesEachHour = function () {
  for (var i = 0; i < hours.length; i++) {
...
// Important that these are called in order to access correct index of ulElementsArray
// ballard.render();
locationOne.render();
// locationTwo.render();
